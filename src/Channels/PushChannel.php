...
use Rahulonewayit\PushNotification\Events\NotificationPushed;
...
abstract class PushChannel
{
     ...
     * @param  mixed $to
     * @param  array $data
     * @param  \Rahulonewayit\PushNotification\Messages\PushMessage $message
     * @return mixed
     */
     ...
     * @param  mixed $notifiable
     * @param  \Illuminate\Notifications\Notification  $notification
     * @return \Rahulonewayit\PushNotification\Messages\PushMessage
     */
